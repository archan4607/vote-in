                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <div class="auth-logo">
                                    <a href="index.php" class="logo logo-dark text-center">
                                        <span class="logo-lg">
                                            <img src="assets/images/VI-logo-removebg.png" alt="VoteIn-Logo" class="rounded mx-auto d-block" style=" height: 5rem; width:10rem;">
                                        </span>
                                    </a>
                                </div>
                            ...
                            <form method="POST" action="con-forgot-mail.php">
                                ...
                                <div class="text-center d-grid">
                                    <button class="btn btn-primary" type="submit" name="submit" onclick="check();"> Send Email </button>
                                </div>
                                <script>
                                    function check() {
                                        Swal.fire({
