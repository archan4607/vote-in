...
<div class="navbar-custom">
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-end mb-0">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="../upload/user/<?php echo $_SESSION['user_img']; ?>" alt="user-image" onerror="this.src='../assets/images/default.jpg'" class="rounded-circle">
                        ...
                        <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                            ...
                            <!-- <a href="user-lock-screen.php" class="dropdown-item notify-item">
                ...
                <!-- LOGO -->
                <div class="logo-box">
                    <a href="user-main-dashboard.php" class="logo logo-dark text-center">
                        <span class="logo-sm">
                    ...
                    <a href="user-main-dashboard.php" class="logo logo-light text-center">
                        <span class="logo-sm">
                            <img src="../assets/images/VI-short-logo.png" alt="" height="30">
                        </span>
                        <span class="logo-lg">
        ...
        <div class="left-side-menu">
            ...
            <div class="h-100" data-simplebar>
                ...
                <div class="user-box text-center">
                    <img src="../upload/user/<?php echo $_SESSION['user_img']; ?>" alt="user-image" onerror="this.src='../assets/images/default.jpg'" title="Mat Helme" class="rounded-circle avatar-md">
                    <div class="dropdown">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            <a href="user-main-dashboard.php">
