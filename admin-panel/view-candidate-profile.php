                            ...
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <div class="text-start mt-4" style="margin-left: 2rem;">
                                        ...
                                        <p class=" mb-3 font-15 text-black"><strong>Enrollment No. :</strong> <span class="ms-2"><?php echo  $can_fetch['UserEnrollment'];  ?></span></p>
                                        
                                        <!-- <p class=" mb-3 font-15"><strong>Password :</strong><span class="ms-2"><?php echo  md5($can_fetch['UserPassword']);  ?></span></p> -->
                                        <p class=" mb-3 font-15 text-black"><strong>Name :</strong> <span class="ms-2"><?php echo  $can_fetch['UserName'];  ?></span></p>
                                        ...
                                        <p class=" mb-3 font-15 text-black"><strong>Mobile :</strong><span class="ms-2"><?php if($can_fetch['UserNumber']==0){ echo ""; }else { echo $can_fetch['UserNumber'];}  ?></span></p>

                                        <p class=" mb-3 font-15 text-black"><strong>Email :</strong> <span class="ms-2"><?php echo  $can_fetch['UserEmail'];  ?></span></p>

                                        <p class=" mb-3 font-15 text-black"><strong>Field :</strong><span class="ms-2"><?php echo  $can_fetch['CandidateField'];  ?></span></p>
                                        ...
                                        if ($admin_fetch['AdminShowResult'] == "1" or $admin_fetch['AdminShowResult'] == "2,3" or $admin_fetch['AdminShowResult'] == "1,2" or $admin_fetch['AdminShowResult'] == "1,3") { ?>
                                            <p class=" mb-3 font-15 text-black"><strong>Votes :</strong><span class="ms-2"><?php echo  $can_fetch['CandidateVotes'];  ?></span></p>
